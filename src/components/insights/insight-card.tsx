  ...
  return (
    <article className={cn("group h-full", className)}>
      <Link
        ...
        className="flex h-full flex-col border-t border-ink pt-6 transition-colors duration-300"
      >
        ...
        <h3 className="font-display mt-5 text-[1.375rem] leading-[1.15] font-bold tracking-[-0.03em] transition-colors duration-300 group-hover:text-accent">
